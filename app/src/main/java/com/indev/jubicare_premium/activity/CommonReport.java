...
ReportsPojo reportsPojo;
    ...
    private Context context = this;
     TextView view_prescription_click, tv_doctor_name1, tv_test1, tv_patient_date;
...
//        String test = sharedPrefHelper.getString("test", "");
        tv_patient_date.setText(date);
        tv_doctor_name1.setText(doctor_name);
        tv_test1.setText(test);
...
//    }
    ...
    private void initViews() {
        ...
        tv_doctor_name1 = findViewById(R.id.tv_doctor_name1);
        tv_test1 = findViewById(R.id.tv_test1);
        tv_patient_date = findViewById(R.id.tv_patient_date);
    }
