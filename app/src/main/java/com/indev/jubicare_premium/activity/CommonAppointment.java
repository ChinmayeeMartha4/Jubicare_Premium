...
//
//        tv_date_assigned_doctor1 = findViewById(R.id.tv_date_assigned_doctor1);
//        tv_assigned_doctor1 = findViewById(R.id.tv_assigned_doctor1);
//        tv_patient_symptoms1 = findViewById(R.id.tv_patient_symptoms1);
//        tv_date_taking_any_prescription1 = findViewById(R.id.tv_date_taking_any_prescription1);
//        tv_taking_any_prescription1 = findViewById(R.id.tv_taking_any_prescription1);
//        tv_taking_prescription_any_date = findViewById(R.id.tv_taking_prescription_any_date);
//        tv_any_emergency1 = findViewById(R.id.tv_any_emergency1);
//
//        tv_patient_remarkss1 = findViewById(R.id.tv_patient_remarkss1);
//        view_prescription_click = findViewById(R.id.view_prescription_click);
//
//        tv_bpupperP1 = findViewById(R.id.tv_bpupperP1);
//        tv_bplowerP1 =findViewById(R.id.tv_bplowerP1);
//        tv_PulseP1 = findViewById(R.id.tv_PulseP1);
//        tv_sugarP1 = findViewById(R.id.tv_sugarP1);
//        tv_tempratureP1 = findViewById(R.id.tv_tempratureP1);
//        tv_blood_oxygen_levelP1 = findViewById(R.id.tv_blood_oxygen_levelP1);
...
//        oldAppointmentPojo.setPatient_appointment_id(sharedPrefHelper.getString("id", ""));
...
////        oldAppointmentPojo.setSymptom_id(sharedPrefHelper.getString("symptom", ""));
//
