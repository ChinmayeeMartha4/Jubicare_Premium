...
import com.indev.jubicare_premium.database.Block;
import com.indev.jubicare_premium.database.BloodGroupModel;
import com.indev.jubicare_premium.database.Caste;
import com.indev.jubicare_premium.database.DiseaseModel;
import com.indev.jubicare_premium.database.District;
import com.indev.jubicare_premium.database.IvrCallingMasking;
import com.indev.jubicare_premium.database.MedicineListModel;
import com.indev.jubicare_premium.database.MedicineStock;
...
import com.indev.jubicare_premium.database.Postoffice;
import com.indev.jubicare_premium.database.PrescriptionDays;
import com.indev.jubicare_premium.database.PrescriptionEatingSchedule;
import com.indev.jubicare_premium.database.PrescriptionInterval;
import com.indev.jubicare_premium.database.State;
import com.indev.jubicare_premium.database.SubTestsModel;
import com.indev.jubicare_premium.database.Symptom;
import com.indev.jubicare_premium.database.SymptomModel;
import com.indev.jubicare_premium.database.Test;
import com.indev.jubicare_premium.database.ReportsPojo;
import com.indev.jubicare_premium.database.Village;
...
//        db.execSQL(AppointmentTestModel.CREATE_TABLE);
        ...
        db.execSQL(OrganizationModel.CREATE_TABLE);
    }
...
//                        PhcPojo phcPojo = new PhcPojo();
    ...
    public ArrayList<String> getspnOrganizationData() {
        SQLiteDatabase db = this.getReadableDatabase();
        ArrayList<String> arrayList = new ArrayList<>();
        try {
            if (db != null && db.isOpen() && !db.isReadOnly()) {
